//
//  AccountCustomizerView.swift
//  CollabClient
//
//  Created by u1034691 on 3/23/19.
//  Copyright © 2019 u1034691. All rights reserved.
//

import UIKit

class AccountCustomizerView: UIView {
    ...
    override func layoutSubviews(){
        ...
        let SignUp = UIButton()
        SignUp.frame = CGRect(x: bounds.maxX * 0.3, y: bounds.maxY * 0.05, width: bounds.maxX * 0.4, height: bounds.maxY * 0.1)
        ...
        firstName.frame = CGRect(x: bounds.maxX * 0.30, y: bounds.maxY * 0.5, width: bounds.maxX * 0.6, height: bounds.maxY * 0.07)
        ...
        firstNameLabel.frame = CGRect(x: bounds.maxX * 0.1, y: bounds.maxY * 0.5, width: bounds.maxX * 0.2, height: bounds.maxY * 0.08)
        ...
        lastName.frame = CGRect(x: bounds.maxX * 0.30, y: bounds.maxY * 0.6, width: bounds.maxX * 0.6, height: bounds.maxY * 0.07)
        ...
        lastNameLabel.frame = CGRect(x: bounds.maxX * 0.1, y: bounds.maxY * 0.6, width: bounds.maxX * 0.2, height: bounds.maxY * 0.08)
        ...
        //let Submit = UIButton()
//        submitButton.frame = CGRect(x: bounds.maxX * 0.35, y: bounds.maxY * 0.80, width: bounds.maxX * 0.3, height: bounds.maxY * 0.1)
...
//        self.addSubview(submitButton)
        ...
        emailAddress.frame = CGRect(x: bounds.maxX * 0.30, y: bounds.maxY * 0.30, width: bounds.maxX * 0.6, height: bounds.maxY * 0.07)
        ...
        emailLabel.frame = CGRect(x: bounds.maxX * 0.03, y: bounds.maxY * 0.30, width: bounds.maxX * 0.3, height: bounds.maxY * 0.07)
        ...
        Password.frame = CGRect(x: bounds.maxX * 0.30, y: bounds.maxY * 0.4, width: bounds.maxX * 0.6, height: bounds.maxY * 0.07)
        ...
        passLabel.frame = CGRect(x: bounds.maxX * 0.1, y: bounds.maxY * 0.4, width: bounds.maxX * 0.2, height: bounds.maxY * 0.08)
